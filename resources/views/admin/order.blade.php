                    ...
                    if(res.data){
                        ...
                        $.each(res.data, function(key, cf){
                            ...
                            if(cf.product_status === "reject"){
                                status = "<div style='display:flex;flex-direction:column;margin-top:0.5rem'><div style='color:red'>DITOLAK</div><div>"+cf.deskripsi_product+"</div><a style='font-size:1rem;color:green;font-weight:bold;' href='/storage/"+cf.bukti+"'target='_blank'>Lihat Bukti</a><button value="+cf.id_orders+" type='button' class='btn-kirim-ulang btn btn-sm btn-primary'>Kirim Ulang</button></div>"
                            }else if(cf.product_status === "terima"){
                                status = "<div><div style='color:green;margin-top:0.5rem' >DITERIMA</div><a style='font-size:1rem;color:green;font-weight:bold;' href='/storage/"+cf.bukti+"'target='_blank'>Lihat Bukti</a></div>"
